...
$_lang['TITLE_LIMIT'] = 'Title limit';
$_lang['TITLE_LIMIT_DESC'] = 'The maximum number of characters for the article title.';
$_lang['COMMENT_LIMIT'] = 'Comment limit';
$_lang['COMMENT_LIMIT_DESC'] = 'The maximum number of characters for the comment message.';
$_lang['NAME_LIMIT'] = 'Name limit';
$_lang['NAME_LIMIT_DESC'] = 'The maximum number of characters for the commentator name.';
...
$_lang['GO_TO_ARTICLE'] = 'Go to article';
$_lang['TITLE_COLOUR'] = 'Title colour';
$_lang['BG_COLOUR'] = 'Background colour';
$_lang['FONT_COLOUR'] = 'Font colour';
$_lang['STYLE'] = 'Style';
