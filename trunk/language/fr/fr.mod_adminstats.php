...
$_lang['STATS_TYPE'] = 'Type de statistiques';
$_lang['STATS_TYPE_DESC'] = 'Type par défaut de statistiques à afficher';
...
$_lang['SWITCH_TO'] = "Basculer à %s"; //translators help: Switch to {STATISTICS_TYPE}
...
$_lang['CHANGE_MOD_PARAMS'] = 'Changer le paramètre de ce module';
$_lang['MORE'] = 'Plus';
