...
$_lang['STATS_TYPE'] = 'نوع الإحصاءات';
$_lang['STATS_TYPE_DESC'] = 'النوع الافتراضي لعرض الإحصاءات';
$_lang['UNIQUE_VISITS'] = 'الزيارات الفريدة';
$_lang['CLICKS'] = 'نقرات';
$_lang['VISITS'] = 'زيارات';
$_lang['PREV_MONTH'] = 'الشهر السابق';
$_lang['NEXT_MONTH'] = 'الشهر المقبل';
$_lang['SWITCH_TO'] = "التحويل لأسلوب عرض الـ %s"; //translators help: Switch to {STATISTICS_TYPE}
