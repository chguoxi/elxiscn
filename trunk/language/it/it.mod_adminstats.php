...
$_lang['STATS_TYPE'] = 'Tipologia statistiche';
$_lang['STATS_TYPE_DESC'] = 'Tipologia statistiche predefinita da visualizzare';
$_lang['UNIQUE_VISITS'] = 'Visite uniche';
$_lang['CLICKS'] = 'Clicks';
$_lang['VISITS'] = 'Visite';
$_lang['PREV_MONTH'] = 'Mese precedente';
$_lang['NEXT_MONTH'] = 'Mese successivo';
$_lang['SWITCH_TO'] = "Passa a %s"; //translators help: Switch to {STATISTICS_TYPE}
