...
$_lang['PASSRECOVNALL'] = 'Il recupero password non è consentito. Per favore contatta l\'amministratore del sito per cambiare la vostra password.';
$_lang['SECLEVNALLRP'] = 'Il livello di sicurezza del sito non consente il recupero password. Per favore contatta l\'Amministratore del sito.';
$_lang['PASSRECOVDESC'] = 'Inserisci la tua username e indirizzo e-mail usato in fase di registrazione. Se le informazioni inviate sono corrette, una nuova password sarà generata e inviata al vostro indirizzo e-mail.';
$_lang['USERNFOUND'] = 'Utente non trovato!';
$_lang['NEWPASSGENREQ'] = 'Una nuova password è stata generata dopo la vostra richiesta. Puoi effettuare il login usando la tua username e la password mostrata sotto.';
...
$_lang['USERSCENTRALDESC'] = 'Benvenuto alla centrale utenti del sito. Da qui è possibile accedere alle pagine dei vari utenti connessi a seconda dello stato e del livello di accesso. In questa area è possibile anche impostare le preferenze di navigazione.';
...
La forza di un gruppo è basata sulla suo <strong>livello di accesso</strong>. Più è alto il livello di accesso più il gruppo potrà accedere a più aree riservate del sito. I gruppi utente personalizzati possono avere accessi <strong>da 2 a 99</strong>. Puoi definire 2 o più gruppi con lo stesso livello di accesso. Nel gruppo utente <strong>Ospite</strong> l\'utente ha accesso 0. <strong>Gli utenti esterni</strong> 
	sono ospiti essendo loggati con metodi di autenticazione esterni come Gmail e Facebook. Gli utenti esterni sono più deboli rispetto agli utenti standard. È richiesto un livello minimo di accesso pari a <strong>70</strong> per un utente
	che può accedere <strong>alla console amministrativa</strong>. Alcuni gruppi di utenti non possono essere modificati o eliminati. Per ulteriori informazioni si prega di leggere la documentazione Elxis.';
