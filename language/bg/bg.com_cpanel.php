...
$_lang['REPO_PATH_INFO'] = 'Пълната пътека към папката repository на Elxis. Остави го празно за местоположението по подразбиране (elxis_root/repository/). Горещо препоръчваме да преместите папката извън папката WWW 
...
$_lang['LOG'] = 'Запис';
$_lang['LOG_INFO'] = 'Ниво на записване на грешки. Избери кои грешки искаш Elxis да записва в системните отчети (repository/logs/).';
$_lang['ALERT'] = 'Рапорт';
